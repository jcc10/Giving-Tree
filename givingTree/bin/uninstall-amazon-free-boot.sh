...
# Removes GivingTree boot replacement and restores normal Kindle boot

UPSTART_CONF="/etc/upstart/givingtree-boot.conf"
KEEPER_PID_FILE="/var/tmp/givingtree-keeper.pid"
...
$FBINK -y 11 -pm "• Remove GivingTree boot configuration"
$FBINK -y 12 -pm "• Restore Amazon framework startup"
$FBINK -y 13 -pm "• Clean up boot-related temporary files"
$FBINK -y 14 -pm ""
$FBINK -y 15 -pm "Note: GivingTree launcher will still be"
...
WATCHDOG_PID_FILE="/var/tmp/givingtree-watchdog.pid"
...
$FBINK -y 12 -pm ""
$FBINK -y 13 -pm "GivingTree launcher is still available:"
$FBINK -y 14 -pm "  KUAL → Kindle Launcher"
$FBINK -y 15 -pm "           → Launch GivingTree"
$FBINK -y 16 -pm ""
...
$FBINK -y 23 -pm "Reboot in 30s now..."
